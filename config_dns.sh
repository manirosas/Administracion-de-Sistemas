#!/bin/bash
# =============================================================================
#  dns_manager_opensuse.sh
#  Gestor automatizado de servidor DNS con BIND9
#  Sistema Operativo : OpenSUSE Leap 15.x
#  Interfaz de Red   : enp0s8 (fija según requerimientos)
