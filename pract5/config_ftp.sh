...
#
# Estructura visible al conectar via FTP (chroot en /srv/ftp/<usuario>):
#   /general/         bind mount -> /srv/ftp/general      (escritura)
#   /reprobados/      bind mount -> /srv/ftp/reprobados   (o recursadores)
#   /<nombre_usuario>/ carpeta personal                   (escritura)
# ============================================
crear_usuarios() {
    echo ""
...
# Util tras reinicio del sistema si los mounts no se aplicaron
# ============================================
remontar_todo() {
    echo ""
